...
<p><img src="images/slide6.png" alt="" float="left" /></p>
...
<p><img src="images/slide8.png" alt="" /></p>
<p><img src="images/slide9.png" alt="" /></p>
...
| ------------- |:-------------:|:-----:|:--------:|
| ![Image insert](images/Screenshot_1.png)   | Every member of a population has an equal chance of being selected E.g. Pulling names out of a hat  | For very large samples it provides the best chance of an unbiased representative sample     |  For large populations it is time- consuming to create a list of every individual.  |
| ![Image insert](images/Screenshot_2.png)| Dividing the target population into important subcategories Selecting members in proportion that they occur in the population E.g. 2.5% of British are of Indian origin, so 2.5% of your sample should be of Indian origin. and so on | A deliberate effort is made to make the sample representative of the target population|It can be time consuming as the subcategories have to be identified and proportions calculated |
| ![Image insert](images/Screenshot_3.png)        | Individuals who have chosen to be involved in a study. Also called self- selecting E.g. people who responded to an advert for participants| Relatively convenient and ethical if it leads to informed consent |  Unrepresentative as it leads to bias on the part of the participant. E.g. a daytime TV advert would not attract full-time workers.  |
| ![Image insert](images/Screenshot_4.png) | Simply selecting those people that are available at the time. E.g. going up to people in cafés and asking them to be interviewed  | Quick, convenient and economical. A most common type of sampling in practice | Very unrepresentative samples and often biased by the researcher who will likely choose people who are ‘helpful’  |


### Conveniance sampling and snowball sampling

![Convenience sampling](images/slide12-1.png)

![Snowball sampling](images/slide12-2.png)
...
![Average throw of 6-sided dice](images/slide18.png)
...
![IQ score sampling distribution](images/slide19.png)
...
![Image insert](images/slide21.png)
...
![2005 article](images/slide26.png)
...
![Normal distribution](images/slide27.png)
...
![Confidence interval mean](images/slide291.png)
...
### 1. Load packages and data
 ...
 Packages might have to be installed outside learnR interface
...
Don't forget to install the package. You might have to install it seperately from tutorial. Try creating new R file in R Studio and use command `install.packages('tigerstats')`
...
First, load lsr package for `ciMean()`
