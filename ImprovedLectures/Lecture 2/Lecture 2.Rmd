...
### Exercise 1: Calculating the CI in R
...
```
```{r ex80-hint}
#Call datasets with function data() and load libraries with library()
library('datasets')
data("discoveries")
data('trees')
```
...
#Use randomsample from previous data to create variable: mean.srs
